1. Reactive programming - to deepin
2. Spring (to get on top of what Spring is built)
3. sql - to deepin (recall normalization, types of indexes, performance tuning etc.)
4. nosql - to deepin
