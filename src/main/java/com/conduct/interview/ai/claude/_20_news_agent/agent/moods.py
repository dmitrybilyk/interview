...
MOOD_RULES = {
    "positive": (
        ...
        "X6. Front-line combat videos or reports of individual Russian soldiers being killed, "
        "wounded, or hit by a Ukrainian drone at the front — even if shown as a Ukrainian "
        "success. These are NOT the official daily losses count. "
        "Signals: 'відео', 'ВІДЕО', 'відеозапис', 'тіло окупанта', 'тіло ворога', "
        "'летить', 'влучання дрона', 'оператори безпілотників', 'БпЛА вразив', "
        "'нищівна сила', 'роботу дрона', local combat clip near Ukrainian cities "
        "(Вовчанськ, Авдіївка, Бахмут, Херсон, Запоріжжя, Суми front area, etc.). → REJECT.\n"
