...
MOOD_RULES = {
    "positive": (
        ...
        "FROM UKRAINE hitting Russian refineries (НПЗ), depots, airfields, military "
        "or industrial sites INSIDE RUSSIA. CRITICAL: the direction matters — "
        "Russia striking a Ukrainian city (Kramatorsk, Kharkiv, Odesa, Dnipro, "
        "Zaporizhzhia, Kherson, etc.) is the OPPOSITE and must be DROPPED, even "
        "if the words 'attack/атака/удар' appear. Ukrainian people dying in a "
        "Russian strike on a Ukrainian city is ALWAYS a NEGATIVE event; "
