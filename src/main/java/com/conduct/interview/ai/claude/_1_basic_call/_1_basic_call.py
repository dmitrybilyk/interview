"""
Topic: Basic API call — model comparison (Haiku vs Sonnet vs Opus)
Cert notes section: MFO Foundations
Run: ../venv/bin/python _1_basic_call.py
"""
...
# ── Same question — Opus (most capable, most expensive) ────────────────────
print("\n=== Same question with Opus ===")
response_opus = client.messages.create(
    model="claude-opus-4-7",
    max_tokens=256,
    messages=[{"role": "user", "content": QUESTION}],
)
print("Answer:", response_opus.content[0].text)
print("Usage:", response_opus.usage)
