...
/**
 * Created with IntelliJ IDEA. User: flash Date: 12.12.12 Time: 8:58 To change this template use
...
public class _ComparableInterface {
  ...
  // Conventions are the same as for equals(). The difference between them - is only that
  // compareTo()
