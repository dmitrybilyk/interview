package com.conduct.interview._1_bases.bloh;

/**
 * Created with IntelliJ IDEA. User: flash Date: 10.12.12 Time: 21:13 To change this template use
...
public class OverrideHashCodeWithEquals {
  ...
  //    hashCode приводит к тому, что двум равным экземплярам соответствует разный хэш-код, т. е.
  // имеем
  //    нарушение соглашений для этого метода. Как следствие, метод get ищет указанный телефонный
  // номер
  //    в другом сегменте хэш-таблицы, а не там, где была сделана запись с помощью метода put.
  // Разрешить
  ...
  // You should include to hashCode function fields that you use in Equals() method (valuable
  // fields)
