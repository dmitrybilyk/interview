...
/**
 * Created with IntelliJ IDEA. User: flash Date: 09.12.12 Time: 14:18 To change this template use
...
//
//    There is only one case when you don't have to override EQUALS for class that have logical
// meaning.
