...
public class Combined {
  ...
  public static void main(String[] args) {
    ...
    //        get from source list not orange but citrus (different type, has different set of
    // fields even).
    ...
    //        So in case of covariant type we can send to `totalWeight` method list of mentioned
    // class and
    //        also lists of all his children. To read from this covariant list we may class Citrus
    // and all his
    ...
    //        addToListWithContravarianceOranges(new ArrayList<BigRoundOrange>()); // not ok, can't
    // send list of children
    //
    //        From Contravariant type we can get just Object as it's a Parent of anything. It's
    // impossible
    //        to determine which parent you want and java returns just Object.
    //        We can send to such a methods just List of edge type or it's Parents (because adding
    // the child would
    //        add new fields....
  ...
  private static int totalWeightWithCovarianceCitruses(ArrayList<? extends Citrus> citruses) {
    ...
    //  but we can't read of course child objects because on the left side we should have the same
    // or bigger:
  ...
  private static void addToListWithContravarianceOranges(ArrayList<? super Orange> oranges) {
    ...
    //        Orange orange = oranges.get(0); //can't as it's impossible for java to understand
    // which type
