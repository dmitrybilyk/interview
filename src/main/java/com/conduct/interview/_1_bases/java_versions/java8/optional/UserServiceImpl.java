package com.conduct.interview._1_bases.java_versions.java8.optional;
...
public class UserServiceImpl {
  ...
  public String getUserAddress(User user) {
    return Optional.of(user)
        ...
        .orElse("EMPTRY STRING");
  }

  //    public Integer getHouseNumber(User user) {
  //        return
  // Optional.of(user).flatMap(User::getAddress).flatMap(Address::getHouseNumber).orElse(77);
  //    }
}
